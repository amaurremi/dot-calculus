...
| - path                                              | Figure 1      | Definitions.v          |  x.a.b.c<br><br>p.a (single field selection)<br><br>p.b̅ (selection of a list of fields)       |  `p_sel x (c::b::a::nil)` <br><br>`p•a`<br> <br>`p••b`                                                              | `path`                   |
